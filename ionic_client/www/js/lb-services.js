 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/quizzes/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Quiz.questions.findById() instead.
            ...
            // INTERNAL. Use Quiz.questions.destroyById() instead.
            ...
            // INTERNAL. Use Quiz.questions.updateById() instead.
            ...
            // INTERNAL. Use Quiz.appuser() instead.
            "prototype$__get__appuser": {
              url: urlBase + "/quizzes/:id/appuser",
              method: "GET",
            },

            // INTERNAL. Use Quiz.questions() instead.
            ...
            // INTERNAL. Use Quiz.questions.create() instead.
            "prototype$__create__questions": {
              url: urlBase + "/quizzes/:id/questions",
              method: "POST",
            },

            // INTERNAL. Use Quiz.questions.destroyAll() instead.
            "prototype$__delete__questions": {
              url: urlBase + "/quizzes/:id/questions",
              method: "DELETE",
            },

            // INTERNAL. Use Quiz.questions.count() instead.
             ...
             */
            "status": {
              url: urlBase + "/quizzes/status",
              method: "GET",
            },

            // INTERNAL. Use Question.quiz() instead.
            "::get::Question::quiz": {
              url: urlBase + "/questions/:id/quiz",
              method: "GET",
            },

            // INTERNAL. Use Appuser.quizzes.findById() instead.
            "::findById::Appuser::quizzes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/appusers/:id/quizzes/:fk",
              method: "GET",
            },

            // INTERNAL. Use Appuser.quizzes.destroyById() instead.
            "::destroyById::Appuser::quizzes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/appusers/:id/quizzes/:fk",
            ...
            // INTERNAL. Use Appuser.quizzes.updateById() instead.
            "::updateById::Appuser::quizzes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/appusers/:id/quizzes/:fk",
            ...
            // INTERNAL. Use Appuser.quizzes() instead.
            "::get::Appuser::quizzes": {
              isArray: true,
              url: urlBase + "/appusers/:id/quizzes",
              method: "GET",
            },

            // INTERNAL. Use Appuser.quizzes.create() instead.
            "::create::Appuser::quizzes": {
              url: urlBase + "/appusers/:id/quizzes",
              method: "POST",
            },

            // INTERNAL. Use Appuser.quizzes.createMany() instead.
            "::createMany::Appuser::quizzes": {
              isArray: true,
              url: urlBase + "/appusers/:id/quizzes",
              method: "POST",
            },

            // INTERNAL. Use Appuser.quizzes.destroyAll() instead.
            "::delete::Appuser::quizzes": {
              url: urlBase + "/appusers/:id/quizzes",
              method: "DELETE",
            },

            // INTERNAL. Use Appuser.quizzes.count() instead.
            "::count::Appuser::quizzes": {
              url: urlBase + "/appusers/:id/quizzes/count",
              method: "GET",
            },
          }
        );
    ...
    /**
     * @ngdoc object
     * @name lbServices.Quiz.questions
     * @header lbServices.Quiz.questions
     * @object
     * @description
     *
     * The object `Quiz.questions` groups methods
     * manipulating `Question` instances related to `Quiz`.
     *
     * Call {@link lbServices.Quiz#questions Quiz.questions()}
     ...
     */
        ...
        R.questions = function() {
          ...
          var action = TargetResource["::get::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#count
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
             * Counts questions of quiz.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.questions.count = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::count::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#create
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
        ...
        R.questions.create = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::create::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#createMany
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
        ...
        R.questions.createMany = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::createMany::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#destroyAll
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
        ...
        R.questions.destroyAll = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::delete::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#destroyById
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
        ...
        R.questions.destroyById = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::destroyById::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#findById
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
        ...
        R.questions.findById = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::findById::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz.questions#updateById
             * @methodOf lbServices.Quiz.questions
             *
             * @description
             *
        ...
        R.questions.updateById = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::updateById::Quiz::questions"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Quiz#appuser
             * @methodOf lbServices.Quiz
             *
             * @description
             *
        ...
        R.appuser = function() {
          ...
          var action = TargetResource["::get::Quiz::appuser"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/questions/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Quiz.questions.createMany() instead.
            "::createMany::Quiz::questions": {
              isArray: true,
              url: urlBase + "/quizzes/:id/questions",
              method: "POST",
            },
        ...
        */
        ...
        R.quiz = function() {
          ...
          var action = TargetResource["::get::Question::quiz"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.Appuser.quizzes
     * @header lbServices.Appuser.quizzes
     * @object
     * @description
     *
     * The object `Appuser.quizzes` groups methods
     * manipulating `Quiz` instances related to `Appuser`.
     *
     * Call {@link lbServices.Appuser#quizzes Appuser.quizzes()}
     * to query all related instances.
     */
        ...
        R.quizzes = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::get::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#count
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
             * Counts quizzes of appuser.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.quizzes.count = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::count::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#create
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
        ...
        R.quizzes.create = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::create::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#createMany
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
        ...
        R.quizzes.createMany = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::createMany::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#destroyAll
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
        ...
        R.quizzes.destroyAll = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::delete::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#destroyById
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
        ...
        R.quizzes.destroyById = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::destroyById::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#findById
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
        ...
        R.quizzes.findById = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::findById::Appuser::quizzes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Appuser.quizzes#updateById
             * @methodOf lbServices.Appuser.quizzes
             *
             * @description
             *
        ...
        R.quizzes.updateById = function() {
          var TargetResource = $injector.get("Quiz");
          var action = TargetResource["::updateById::Appuser::quizzes"];
          return action.apply(R, arguments);
        };
